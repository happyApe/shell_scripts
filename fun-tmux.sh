...
# tmux configuration for fun stuff, my automation scripts in the webscraping folder
...
then
    ...
    tmux send-keys -t 'vim' "cd ~/Playground/Automate\ Boring\ Stuff/WebScraping/" C-m 'clear' C-m

    # Create another window
    tmux new-window -t $SESSION:2 -n 'zsh'
    # tmux send-keys -t 'zsh' "source ~/py3.6/bin/activate" C-m 'clear' C-m
    tmux send-keys -t 'zsh' "cd ~/Playground/Automate\ Boring\ Stuff/WebScraping/" C-m 'clear' C-m
